...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeySecret = config('aliyunSms.accessKeySecret'); // AccessKeySecret
    ...
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName(config('aliyunSms.singName'));
        
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(config('aliyunSms.templateCode'));
